  ...
  return (
    <div className="bg-white rounded shadow overflow-hidden">
      <div className="overflow-x-auto">
        <div style={{ minWidth: TABLE_WIDTH, width: TABLE_WIDTH }}>
          <div className="flex font-semibold bg-indigo-50 text-[12px] text-gray-800 border-b sticky top-0 z-20">
            <div className="w-[220px] px-2 py-2 shrink-0 sticky left-0 z-30 bg-indigo-50 border-r">
              Call SID
            </div>
            <div className="w-[140px] px-2 py-2 shrink-0">To</div>
            <div className="w-[140px] px-2 py-2 shrink-0">From</div>
            <div className="w-[160px] px-2 py-2 shrink-0">Campaign</div>
            <div className="w-[80px] px-2 py-2 shrink-0">Dur</div>
            <div className="w-[120px] px-2 py-2 shrink-0">Status</div>
            <div className="w-[130px] px-2 py-2 shrink-0">Disposition</div>
            <div className="w-[120px] px-2 py-2 shrink-0">Stage</div>
            <div className="w-[120px] px-2 py-2 shrink-0">Recording</div>
            <div className="w-[160px] px-2 py-2 shrink-0">Date</div>
            <div className="w-[100px] px-2 py-2 shrink-0">Details</div>
          </div>
            ...
            >
              {rowVirtualizer.getVirtualItems().map((virtualRow) => {
                ...
                return (
                  ...
                  >
                    <div className="w-[220px] px-2 truncate shrink-0 sticky left-0 z-10 bg-white border-r">
                      {log.callSid || "-"}
                    </div>

                    <div className="w-[140px] px-2 truncate shrink-0">
                      {log.toNumber || "-"}
                    </div>
                    ...
                    <div className="w-[160px] px-2 truncate shrink-0">
                      {log.campaign?.name || "-"}
                    </div>

                    <div className="w-[80px] px-2 shrink-0">
                      {log.duration ?? 0}s
                    </div>
                    ...
                    <div className="w-[130px] px-2 truncate shrink-0">
                      {log.disposition || log.dispositionDetail?.status || "-"}
                    </div>

                    <div className="w-[120px] px-2 truncate shrink-0">
